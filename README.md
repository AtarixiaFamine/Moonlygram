...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Bot%20API-10.3-2CA5E0.svg" alt="Bot API 10.3">
...
- **Rich:** send rich messages (headings, tables, collapsibles, math) with a composable,
  auto-escaping builder, convert Markdown in one call, or build them from Bot API 10.3
